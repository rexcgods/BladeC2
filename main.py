...
def support():
  print("""
you can dm me in telegram: \x1b[38;5;160m@imfally
""")
...
def main():
    ...
    print("""\x1b[0m
                        WELCOME TO \033[36mBLADEC2 \x1b[0mSIMPLE DDOS TOOL
\x1b[38;2;214;4;844m
\x1b[38;5;34m                      ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣀⠤⣲⠟⠁⠀⠀⠀⠀⠀  ⠀⣠⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
\x1b[38;5;35m                 ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⡠⠖⠋⢀⠞⠁⠀ ⠀⠀⠀  ⠀⢀⠜⡇⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
\x1b[38;5;36m                 ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⡰⠊⠀⠀⡠⠋⠀⠀⠀⠀⠀ ⠀  ⣠⠊⡰⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
...
""")
    ...
    while True:
        ...
        sin = input(" "+Back.GREEN+Fore.BLACK+" root@BladeC2 "+Fore.RESET+Back.RESET+" ►► ")
        sinput = sin.split(" ")[0]
